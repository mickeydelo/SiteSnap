...
- The hosted capture key is bootstrapped only to the signed-in UI. The shared login in `core/auth.js` is the access boundary. Keep protected HTML/scripts out of CDN-served `public/`.
